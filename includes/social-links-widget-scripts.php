...
class social_links_widget_Scripts
{
    ...
    {   
        ...
        add_action('wp_enqueue_scripts', [$this, 'load_social_links_widget_assets_public']);
        add_action('admin_enqueue_scripts', [$this, 'load_social_links_widget_assets_admin']);
        add_action('widgets_init', [$this, 'register_social_links_widget']);
    }
    ...
    public function load_social_links_widget_assets_public()
    {
        ...
        wp_enqueue_script('social-links-widget-script-js', PUBLIC_DIR . '/js/main.js', ['jquery'], $this->version, true);
    }
    ...
    public function load_social_links_widget_assets_admin()
    {
        ...
        wp_enqueue_script('social-links-widget-script-js', ADMIN_DIR . '/js/main.js', ['jquery'], $this->version, true);
    }
